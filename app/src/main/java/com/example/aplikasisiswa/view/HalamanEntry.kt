...
fun EntrySiswaScreen(
    ...
    Scaffold(
        ...
        topBar = {
            SiswaTopAppBar(title = stringResource(id = DestinasiEntry.titleRes), canNavigateBack = true, navigateUp = navigateBack, scrollBehavior = scrollBehavior)
        }
    ) {innerPadding ->
        EntrySiswaBody(
...
fun EntrySiswaBody(
    ...
    Column(
        ...
        FormTambahSiswa(detailSiswa = uiStateSiswa.detailSiswa,
